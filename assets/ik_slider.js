...
;(function ( $, window, document, undefined ) {
 ...
 'aria-label':'Use the right and left arrow keys to increase or decrease the slider value.',					// set slider current value
                    'aria-describedby': id + 'instructions' // add description *
				})
				.addClass('ik_knob')
	...
	Plugin.prototype.setValue = function (n) {
        ...
        this.updateDisplay(n); // update displa
	};
